...
//forest-begin: Tweakable transmission
        builtinData.bakeDiffuseLighting += builtinData.backBakeDiffuseLighting * bsdfData.transmittance * _TransmissionDirectAndIndirectScales[bsdfData.diffusionProfileIndex].g;
//forest-end:
    }
