...
#define DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_(CUSTOM_INPUT_ONLY) (1136)
...
void GetGeneratedSurfaceDataDebug(uint paramId, SurfaceData surfacedata, inout float3 result, inout bool needLinearToSRGB)
{
    switch (paramId)
    {
        ...
        case DEBUGVIEW_STACKLIT_SURFACEDATA_THICKNESS:
            ...
            break;
        case DEBUGVIEW_STACKLIT_SURFACEDATA_SPECULAR_OCCLUSION_(CUSTOM_INPUT_ONLY):
