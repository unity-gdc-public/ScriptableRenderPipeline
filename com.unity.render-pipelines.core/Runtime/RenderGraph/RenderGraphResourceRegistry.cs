...
{
    /// <summary>
    /// Mode used to determine the size of a texture
    /// </summary>
    ...
    public struct TextureDesc
    {
        ...
        /// <param name="xrReady">Set to true if the texture is used as a render texture in an XR setting</param>
        ...
        /// Hash function
        /// </summary>
        /// <returns>Returns the texture descriptor hash</returns>
    ...
    public class RenderGraphResourceRegistry
    {
        ...
        /// <returns>Returns the RTHandle associated with the provided resource handle</returns>
        ...
        /// <returns>Returns the Renderer List associated with the provided resource handle</returns>
